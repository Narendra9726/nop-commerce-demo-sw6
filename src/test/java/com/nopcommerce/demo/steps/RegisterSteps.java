...
public class RegisterSteps {
    ...
    public void enterFirstname(String name) {
        new RegisterPage().enterFirstName("Narendra");
    }

    @And("Enter lastname {string}")
    public void enterLastname(String name) {
        new RegisterPage().enterLastName("Dhaduk");
    }

    @And("Select day {string}")
    public void selectDay(String day) {
        new RegisterPage().selectDate("26");
    }
    ...
    public void selectYear(String year) {
        new RegisterPage().selectYear("1992");
    }

    @And("Enter email {string}")
    public void enterEmail(String email) {
        new RegisterPage().enterEmail("naren123@gmail.com");
    }

    @And("Enter password {string}")
    public void enterPassword(String password) {
        new RegisterPage().enterPassword("Naren123");
    }

    @And("Enter Confirm Password {string}")
    public void enterConfirmPassword(String password) {
        new RegisterPage().enterConfirmPassword("Naren123");
    }
